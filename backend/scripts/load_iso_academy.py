    ...
    async with AsyncSessionLocal() as session:
        try:
            ...
            await session.execute(
                ...
                {
                    "id5": "A.5",
                    "name5": "Controles Organizacionales",
                    "desc5": "Políticas de seguridad, gestión de activos, relaciones con proveedores y cumplimiento corporativo.",
                    "id6": "A.6",
                    "name6": "Controles de Personas",
                    "desc6": "Recursos humanos, términos de empleo, concientización y capacitación técnica de seguridad.",
                    "id7": "A.7",
                    "name7": "Controles Físicos",
                    "desc7": "Perímetros de seguridad, protección de instalaciones, monitoreo físico y resguardo de equipos.",
                    "id8": "A.8",
                    "name8": "Controles Tecnológicos",
                    "desc8": "Cifrado avanzado, criptografía, seguridad en redes, ingeniería de sistemas y desarrollo seguro.",
                },
            )
            ...
            for control in all_controls:
                ...
                description_real = control.get(
                    "description", "Lineamientos de control y gobernanza operativa."
                )

                domain_id = domain_map.get(category, "A.8")
                iso_label = (
                    f"A.{raw_id}" if not str(raw_id).startswith("A.") else raw_id
                )
                ...
                if category == "organizational":
                    ...
                    options = [
                        {
                            "id": "A",
                            "text": "Delegar la seguridad exclusivamente al equipo de desarrollo sin supervisión.",
                        },
                        {
                            "id": "B",
                            "text": "Aprobar, publicar y revisar periódicamente las políticas de seguridad alineadas al negocio.",
                        },
                        {
                            "id": "C",
                            "text": "Evitar documentar los procesos para acelerar la operación de la empresa.",
                        },
                    ]
                    ...
                    options = [
                        {
                            "id": "A",
                            "text": "Únicamente después de que ocurra un incidente crítico de filtración.",
                        },
                        {
                            "id": "B",
                            "text": "De forma regular y sistemática a todos los empleados desde su contratación.",
                        },
                        {
                            "id": "C",
                            "text": "Solo al personal del área de tecnología e infraestructura informática.",
                        },
                    ]
                    ...
                    options = [
                        {
                            "id": "A",
                            "text": "Permitir el acceso libre a las instalaciones para agilizar visitas.",
                        },
                        {
                            "id": "B",
                            "text": "Definir y proteger perímetros físicos, controlando los accesos a áreas críticas mediante autenticación.",
                        },
                        {
                            "id": "C",
                            "text": "Confiar plenamente en la seguridad pública externa sin controles propios.",
                        },
                    ]
                else:  # technological
                    ...
                    options = [
                        {
                            "id": "A",
                            "text": "Desactivar los sistemas de monitoreo para ahorrar espacio de almacenamiento.",
                        },
                        {
                            "id": "B",
                            "text": "Implementar configuraciones seguras, cifrado y control de accesos basados en privilegios mínimos.",
                        },
                        {
                            "id": "C",
                            "text": "Utilizar la misma contraseña maestra en todos los servicios de red.",
                        },
                    ]
            ...
            print(
                f"✅ [HYPERION] ¡Base de datos académica inyectada con éxito! {len(all_controls)} controles distribuidos en todos los dominios."
            )

        except Exception as e:
            await session.rollback()
            print(f"❌ Error durante la siembra masiva: {e!s}")
        finally:
