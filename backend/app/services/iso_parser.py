...
class ISOParser:
    ...
    def _extract_controls(self) -> list[dict]:
        ...
        organizational_controls = [
            ...
            {
                "id": "5.9",
                "title": "Inventario de información y otros activos",
        ...
        people_controls = [
            ...
            {
                "id": "6.3",
                "title": "Concienciación y capacitación",
            ...
            {
                "id": "6.5",
                "title": "Responsabilidades post-empleo",
        ...
        physical_controls = [
            ...
            {
                "id": "7.2",
                "title": "Control de entrada físico",
                "description": "Controles en puntos de acceso.",
            },
            {
                "id": "7.3",
                "title": "Seguridad de oficinas",
            ...
            {
                "id": "7.7",
                "title": "Escritorio y pantalla limpia",
                "description": "Normas de escritorio claro.",
            },
            {
                "id": "7.8",
                "title": "Ubicación de equipos",
                "description": "Equipos protegidos adecuadamente.",
            },
            {
                "id": "7.9",
                "title": "Seguridad de activos externos",
        ...
        technological_controls = [
            ...
            {"id": "8.15", "title": "Registro", "description": "Generación de logs."},
            {
                "id": "8.16",
